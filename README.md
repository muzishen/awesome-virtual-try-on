...
- IMAGPose: A Unified Conditional Framework for Pose-Guided Person Generation, NeurIPS 2024 - [Paper](https://openreview.net/forum?id=6IyYa4gETN), [Code](https://github.com/muzishen/IMAGPose)
- Advancing pose-guided image synthesis with progressive conditional diffusion models, ICLR 2023 - [Paper](https://arxiv.org/pdf/2310.06313),[Code](https://github.com/tencent-ailab/PCDMs)
