...
- Advancing pose-guided image synthesis with progressive conditional diffusion models, ICLR 2024 - [Paper](https://openreview.net/pdf?id=rHzapPnCgT), [code](https://github.com/tencent-ailab/PCDMs)
